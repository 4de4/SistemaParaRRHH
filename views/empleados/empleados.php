...
<body>
	...
	<table border="1" class="tablecliente">
        <thead>
            ...
            <tr>
                <td colspan='14'><a href='crud.php?c=empleado&a=nuevo'>Agregar</a></td>
                <td colspan='14'><a href='crud.php'>Volver</a></td>
            </tr>
            <tr>
                <th>Nombre</th>
                <th>Apellido</th>
        ...
        <tbody>
            ...
            <?php 
                foreach($data["empleado"] as $dato) {
                    ...
                    echo "<td class='btn'><a href='crud.php?c=contrato&a=index&id=".$dato["id_e"]."' class='btn btn-danger'>Contrato</a></td>";
                    echo "</tr>";
                }
